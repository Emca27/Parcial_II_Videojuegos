...
canvas.addEventListener("mousedown", engine.mouseDown);
canvas.addEventListener("mousemove", engine.mouseMove);
canvas.addEventListener("mouseout", engine.mouseOut);
canvas.addEventListener("mouseup", engine.mouseUp);
